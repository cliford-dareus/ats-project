...
const EditJobListingModal = ({isEditJobOpen, setIsEditJobOpen, data}: EditJobModalProps) => {
    ...
    const onsubmit = (data: z.infer<typeof updateJobSchema>) => {
        console.log(data)
    };
                            ...
                            <div className="space-y-1.5">
                                <FormField
                                    ...
                                    render={({field}) => (
                                        <FormItem className="">
                                            <FormLabel
                                                className="text-sm font-bold text-zinc-700 flex items-center gap-2">Job Title</FormLabel>
                                            <FormControl>
                                                <Input
                                ...
                                <div className="space-y-1.5 ">
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem className="">
                                                <FormLabel
                                                    className="text-sm font-bold text-zinc-700 flex items-center gap-2">Job Salary</FormLabel>
                                                <FormControl>
                                                    <Input
                                ...
                                <div className="space-y-1.5 col-span-2">
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem className="">
                                                <FormLabel
                                                    className="text-sm font-bold text-zinc-700 flex items-center gap-2">Description</FormLabel>
                                                <FormControl>
                                                    <Textarea
                                                        className="w-full px-4 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all"
                                                        placeholder="e.g. Senior Product Designer"
                                ...
                                <div className="space-y-1.5">
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem>
                                                <label
                                                    className="text-sm font-bold text-zinc-700 flex items-center gap-2">
