...
type Props = {
  ...
  column: JOB_ENUM;
  setCards: Dispatch<
    SetStateAction<JobListingWithCandidatesType[] | undefined>
  >;
};
  ...
  const handleDragEnd = async (e: DragEvent<HTMLDivElement>) => {
    ...
    if (before !== cardId) {
      ...
      if (title !== "Applied") {
        ...
        // add smart trigger logic
        executeTrigger(dropStage)
    ...
    <div className="min-w-56 w-56">
      <div className="flex items-center justify-between mt-4">
        <div className="flex items-center gap-2">
          ...
          <Badge className="rounded text-xs px-1  py-.5 flex items-center justify-center bg-muted text-slate-500">
      ...
      <div
        ...
        className="h-full w-full transition-colors relative z-50 overflow-y-scroll mt-2"
      >
