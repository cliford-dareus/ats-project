...
import { update_general_settings_action } from "@/server/actions/organization_actions";
import { GeneralSettingsInput, generalSettingsSchema } from "@/zod";
...
const GeneralSettingsForm = ({ initial, rootDomain = "aplico.online" }: Props) => {
    ...
    return (
        <div className="space-y-8 max-w-3xl">
            ...
            {message && (
                <div
                    className={`rounded-xl border px-4 py-3 text-sm ${message.type === "ok"
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {COLOR_PRESETS.map((c) => (
                                                        <button
                                                            ...
                                                            title={c.label}
                                                            className={`h-8 w-8 rounded-full border-2 transition ${field.value === c.value
